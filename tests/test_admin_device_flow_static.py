...
def test_copilot_and_chatgpt_subscription_are_dropdown_device_auth_options():
    assert (
        'value="copilot" data-logo="github" data-auth-flow="copilot">GitHub Copilot'
        in _INDEX
    )
    assert (
        'value="chatgpt-subscription" data-logo="openai" data-auth-flow="chatgpt-subscription">ChatGPT Subscription'
        in _INDEX
    )
